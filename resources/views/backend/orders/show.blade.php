        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                ...
                <div class="card-body table-responsive">
                   <table class="table">
                       <tbody>
                            <tr><td><strong>Transction ID:</strong></td><td class="text-left">{{$order->tran_id}}</td>
                          ...
                          <tr><td><strong>Booking Status:</strong></td><td class="text-left"><span class="badge badge-{{$order->status=='Pending'? 'warning':'success'}}">{{$order->status}}</span></td></tr>
